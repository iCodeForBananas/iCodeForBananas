        ...
        <div className='w-full lg:max-w-5xl lg:mx-auto'>
          <div className='rounded-lg p-6'>
            <div className='text-center mb-10'>
              <h1 className='text-5xl font-bold text-white drop-shadow-lg'>Fretboard</h1>
              <p className='text-lg text-white/80 mt-3'>Explore chords and scales on the guitar fretboard</p>
            </div>
