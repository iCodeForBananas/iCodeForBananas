...
export default function FireEstimatorPage() {
  ...
  return (
    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      {/* Chart */}
      <div className="bg-white rounded-xl border border-yellow-400/30 p-4" style={{ height: 480 }} title="When the purple portfolio line crosses above the pink FIRE target line, you can retire — the green vertical line marks that age">
