...
export default function Songwriter() {
  ...
  return (
    <div className="flex flex-col h-screen">
      {/* Toolbar */}
      <div className="bg-gradient-to-r from-pink-100 to-orange-100 border-b border-pink-200 px-4 py-3 flex items-center justify-between flex-shrink-0">
      ...
      {/* Columns */}
      <div ref={containerRef} className="flex-1 overflow-x-auto overflow-y-hidden bg-gradient-to-br from-pink-50 to-orange-50">
        <div className="flex h-full p-4 gap-4">
          {columns.map((col, i) => (
            <div
              key={i}
              className={`flex-shrink-0 border-2 rounded-lg bg-white shadow-md overflow-hidden ${activeCol === i ? "border-pink-400" : "border-gray-300"}`}
