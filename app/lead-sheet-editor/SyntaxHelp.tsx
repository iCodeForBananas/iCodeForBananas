...
const ENTRIES: Entry[] = [
  ...
  },
  {
    title: "Sound tags",
    blurb:
      "A tag in square brackets on a time-stamped line switches a sound on or off during playback. [drum] starts the drum machine, [/drum] stops it, and the same works for claps and shimmer. Use as many as you like — the kit drops out and comes back in wherever you mark it.",
    example:
