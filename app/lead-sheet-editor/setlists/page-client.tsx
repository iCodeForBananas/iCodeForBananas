...
import { Plus, Trash2, ListMusic, Check, X } from "lucide-react";
import { Button, IconButton, TextField } from "@radix-ui/themes";
import { Bento } from "@/app/components/ui/bento";
import BentoPageLayout from "@/app/components/BentoPageLayout";

const BREADCRUMBS = [{ label: "Lead Sheets", href: "/lead-sheet-editor" }];
...
export default function SetlistList() {
  ...
  if (authLoading) {
    return (
      <BentoPageLayout title='Setlists' breadcrumbs={BREADCRUMBS}>
